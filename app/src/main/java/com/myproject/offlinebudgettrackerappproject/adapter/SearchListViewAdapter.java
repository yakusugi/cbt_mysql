...
public class SearchListViewAdapter extends ArrayAdapter<BudgetTrackerSpending> {
    ...
    public SearchListViewAdapter(Context context, List<BudgetTrackerSpending> budgetTrackerSpendingList) {
        super(context, R.layout.search_list_item, budgetTrackerSpendingList);
    }

    //TODO Someday, I need to adapt LiveData data transactions instead of the traditional List data transactions.
    public SearchListViewAdapter(Context context, LiveData<List<BudgetTrackerSpending>> budgetTrackerSpendingList) {
        super(context, R.layout.search_list_item, (List<BudgetTrackerSpending>) budgetTrackerSpendingList);
    }

    public SearchListViewAdapter(Context context, int num) {
        super(context, num);
    }
