...
public class BudgetTrackerMysqlSpendingProductNameReplaceDao extends BaseSpendingDao {
    ...
    public BudgetTrackerMysqlSpendingProductNameReplaceDao(Context context) {
        super(context);
    }
    ...
    public void replaceProductName(String productNameFrom, String productNameTo, ProductNameReplaceCallback callback) {
        try {
            ...
            String phpFile = loadServerConfig("spending_product_name_replace_php_file");
            String endpoint = serverUrl + phpFile;

            Map<String, String> params = new HashMap<>();
            params.put("email", SharedPreferencesManager.getUserEmail(context));
            params.put("product_name_from", productNameFrom);
            params.put("product_name_to", productNameTo);
