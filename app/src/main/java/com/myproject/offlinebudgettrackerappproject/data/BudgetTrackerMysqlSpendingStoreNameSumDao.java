...
public class BudgetTrackerMysqlSpendingStoreNameSumDao {
    ...
    public void getSearchStoreNameSum(BudgetTrackerMysqlSpendingDto budgetTrackerMysqlSpendingDto, MysqlSpendingSumCallback callback) {
        ...
        Log.d("TAG", "getSearchDateList: " +  storeName + " " +dateFrom + " " + dateTo);
        ...
        try {
            ...
            String phpSelectFile = properties.getProperty("spending_store_sum_php_file");
            ...
            params.put("store_name", budgetTrackerMysqlSpendingDto.getStoreName().toString());
