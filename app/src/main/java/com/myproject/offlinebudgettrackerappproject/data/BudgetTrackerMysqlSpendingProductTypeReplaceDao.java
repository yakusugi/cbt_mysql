...
public class BudgetTrackerMysqlSpendingProductTypeReplaceDao extends BaseSpendingDao {
    ...
    public BudgetTrackerMysqlSpendingProductTypeReplaceDao(Context context) {
        super(context);
    }
    ...
    public void replaceProductType(String productTypeFrom, String productTypeTo, ProductTypeReplaceCallback callback) {
        try {
            ...
            String phpFile = loadServerConfig("spending_product_type_replace_php_file");
            String endpoint = serverUrl + phpFile;

            Map<String, String> params = new HashMap<>();
            params.put("email", SharedPreferencesManager.getUserEmail(context));
            params.put("product_type_from", productTypeFrom);
            params.put("product_type_to", productTypeTo);
