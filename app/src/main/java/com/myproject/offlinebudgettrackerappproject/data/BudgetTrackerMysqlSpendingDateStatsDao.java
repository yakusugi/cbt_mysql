...
public class BudgetTrackerMysqlSpendingDateStatsDao {

    private final Context context;

    public BudgetTrackerMysqlSpendingDateStatsDao(Context context) {
    ...
    public void getSearchDateStatsList(BudgetTrackerMysqlSpendingDto budgetTrackerMysqlSpendingDto, MysqlSpendingListCallback callback) {
        ...
        Log.d("TAG", "getSearchStoreNameList: " + currencyCode  + " " + dateFrom + " " + dateTo);
        ...
        try {
            ...
            String phpSelectFile = properties.getProperty("date_stats_search_php_file");
