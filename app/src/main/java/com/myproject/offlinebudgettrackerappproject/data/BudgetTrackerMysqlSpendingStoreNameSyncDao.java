...
public class BudgetTrackerMysqlSpendingStoreNameSyncDao {
    ...
    public BudgetTrackerMysqlSpendingStoreNameSyncDao(Context context) {
                                ...
                                if (success.equals("1")) {
                                    ...
                                    if (jsonArray != null) {
                                        ...
                                        for (int i = 0; i < jsonArray.length(); i++) {
                                            ...
                                            //todo spendingDao.insertAll(spendingList);
