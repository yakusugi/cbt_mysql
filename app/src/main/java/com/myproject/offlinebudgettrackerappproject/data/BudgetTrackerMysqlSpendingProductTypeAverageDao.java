...
public class BudgetTrackerMysqlSpendingProductTypeAverageDao extends BaseSpendingSumDao {

    public BudgetTrackerMysqlSpendingProductTypeAverageDao(Context context) {
        super(context);
    }
    ...
    public void getProductTypeAverage(BudgetTrackerMysqlSpendingDto budgetTrackerMysqlSpendingDto, StoreNameAverageCallback callback) {
        try {
            ...
            String phpSelectFile = loadServerConfig("spending_product_type_average_php_file");
