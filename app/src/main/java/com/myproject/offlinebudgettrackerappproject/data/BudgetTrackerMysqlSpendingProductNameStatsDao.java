...
public class BudgetTrackerMysqlSpendingProductNameStatsDao extends BaseSpendingStatsDao{
    ...
    public void getSearchProductNameStatsList(BudgetTrackerMysqlSpendingDto budgetTrackerMysqlSpendingDto, MysqlSpendingListCallback callback) {
        ...
        try {
            ...
            String phpFile = loadServerConfig("product_name_stats_search_php_file");
