...
public class BudgetTrackerMysqlIncomeInsertDao {
    private final Context context;

    public BudgetTrackerMysqlIncomeInsertDao(Context context) {
        this.context = context.getApplicationContext();
    }

    private DateUtil dateUtil;

    public void insertIntoIncome(BudgetTrackerMysqlIncomeDto budgetTrackerMysqlIncomeDto, MysqlIncomeInsertCallback callback) {
        try {
            ...
            String phpInsertFile = properties.getProperty("income_insert_php_file");
            ...
            StringRequest stringRequest = new StringRequest(
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (Integer.parseInt(success) > 0) {
                                    ...
                                    List<BudgetTrackerMysqlIncomeDto> spendingList = parseSpendingList(jsonObject);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    String formattedDate = dateFormat.format(budgetTrackerMysqlIncomeDto.getDate());

                    params.put("email", SharedPreferencesManager.getUserEmail(context).toString());
                    params.put("date", formattedDate);
                    params.put("income_category", budgetTrackerMysqlIncomeDto.getIncomeCategory());
                    params.put("income_name", budgetTrackerMysqlIncomeDto.getIncomeName());
                    params.put("income", budgetTrackerMysqlIncomeDto.getIncome().toString());
                    params.put("note", budgetTrackerMysqlIncomeDto.getIncomeNote());
                    params.put("currency_code", budgetTrackerMysqlIncomeDto.getIncomeCurrencyCode());
                    return params;
                }
            };
    ...
    private List<BudgetTrackerMysqlIncomeDto> parseSpendingList(JSONObject jsonObject) throws JSONException, ParseException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            incomeDto.setDate(DateUtil.stringToDate(spendingObject.getString("income_date"), "yyyy-MM-dd"));
            incomeDto.setIncomeCategory(spendingObject.getString("income_category"));
            incomeDto.setIncomeName(spendingObject.getString("income_name"));
            incomeDto.setIncome(Double.parseDouble(spendingObject.getString("income")));
            incomeDto.setIncomeNote(spendingObject.getString("note"));
            incomeDto.setIncomeCurrencyCode(spendingObject.getString("currency_code"));
