...
public class MysqlUserRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mysql_user_registration);
        ...
        Log.d("ViewInitialization", "enterEmail: " + (enterEmail != null) +
                ", enterPassword: " + (enterPassword != null) +
                ", loginButton: " + (loginButton != null) +
                ", registerButton: " + (registerButton != null));

        Log.d("LOGIN_TAG", "Views initialized");

        budgetTrackerMySqlViewModel = new ViewModelProvider.AndroidViewModelFactory(MysqlUserRegistrationActivity.this.getApplication()).create(BudgetTrackerMySqlViewModel.class);
...
//                }
                ...
                budgetTrackerMySqlViewModel.login(budgetTrackerUserDto, new LoginCallback() {
                    ...
                    public void onSuccess() {
                        ...
                        Toast.makeText(MysqlUserRegistrationActivity.this, "Login successful", Toast.LENGTH_SHORT).show();

                        //Share and contain user email info
                        SharedPreferences sharedPref = getSharedPreferences("MyAppPrefs", Context.MODE_PRIVATE);
                        SharedPreferences.Editor editor = sharedPref.edit();
                        editor.putString("user_email", email);
                        SharedPreferencesManager.saveUserEmail(MysqlUserRegistrationActivity.this, email);
                        editor.apply();
...
//                        replaceFragment(new MyqlDashboardFragment());
                    ...
                    public void onFailure(String errorMessage) {
                        ...
                        Toast.makeText(MysqlUserRegistrationActivity.this, "Login failed: " + errorMessage, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
